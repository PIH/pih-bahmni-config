...
set @child_concept_id = @concept_id;
call ensure_concept_set_member (@parent_concept_id, @child_concept_id, 2);
...
set @child_concept_id = @concept_id;
call ensure_concept_set_member (@parent_concept_id, @child_concept_id, 3);
...
set @child_concept_id = @concept_id;
call ensure_concept_set_member (@parent_concept_id, @child_concept_id, 4);
...
set @child_concept_id = @concept_id;
call ensure_concept_set_member (@parent_concept_id, @child_concept_id, 5);
...
set @child_concept_id = @concept_id;
call ensure_concept_set_member (@parent_concept_id, @child_concept_id, 6);
